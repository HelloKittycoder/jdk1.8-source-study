...
/**
 * Created by shucheng on 2019-10-19 下午 18:35
 */
public class LinkedListDemo {
    ...
    public void test1() {
        ...
        linkedList.offerLast(5); // 在此列表的末尾插入指定的元素
        ...
        linkedList.pop(); // 从此列表所表示的堆栈处弹出一个元素（获取并移除）
        System.out.println("After pop(): " + linkedList); // [3, 4]
        linkedList.add(3); // [3, 4, 3]
        linkedList.removeFirstOccurrence(3); // 从此列表中移除第一次出现的指定元素（从头部到尾部遍历列表）
        System.out.println("After removeFirstOccurrence(3): " + linkedList); // [4, 3]
        linkedList.removeLastOccurrence(3); // 从此列表中移除最后一次出现的指定元素（从尾部到头部遍历列表）
        System.out.println("After removeLastOccurrence(3): " + linkedList); // [4]
