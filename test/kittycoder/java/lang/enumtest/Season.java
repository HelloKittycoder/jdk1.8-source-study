...
/**
 * Created by shucheng on 2019-12-8 上午 11:39
 * 手动实现枚举类（一般不会这么做，只是为了能更好地理解枚举类）
 */
public class Season {
    // 把Season类定义成不可变的，将其成员也定义成final的
    ...
    public static final Season WINTER = new Season("冬天", "冬日雪飘");
