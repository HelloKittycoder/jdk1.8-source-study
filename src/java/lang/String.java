...
public final class String
    ...
    */
     ...
     *
     * 获取字符ch在String中第一次出现的索引（从String的首个字符，从前往后开始检查）
     *
     ...
     * (Unicode code units).
     *
     * 获取字符ch在String中第一次出现的索引（从String的指定位置，从前往后开始检查）
     *
     * @param   ch          a character (Unicode code point).
    ...
    public int indexOf(int ch, int fromIndex) {
        ...
        // 检查fromIndex是否符合要求
        // 如果fromIndex<0，则重置为0；如果fromIndex>=-1，就直接返回-1
        if (fromIndex < 0) {
            fromIndex = 0;
        ...
        if (ch < Character.MIN_SUPPLEMENTARY_CODE_POINT) {
            ...
            // （正序遍历）索引从fromIndex到max-1，依次遍历String中的字符，
            // 将其与ch进行对比，如果找到相同的字符，则返回索引
            for (int i = fromIndex; i < max; i++) {
                if (value[i] == ch) {
                    return i;
                }
            }
            // 如果遍历了所有字符，仍然没有找到，则直接返回-1
            return -1;
        } else {
     ...
     * character.
     *
     * 获取字符ch在String中最后一次出现的索引（从String的最后一个字符，从后往前开始检查）
     *
     * @param   ch   a character (Unicode code point).
     ...
     * (Unicode code units).
     *
     * 获取字符ch在String中最后一次出现的索引（从String的指定位置，从后往前开始检查）
     *
     * @param   ch          a character (Unicode code point).
